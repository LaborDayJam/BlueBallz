...
void splyt_core_init(const char* customerId, const char* userId, const char* userProperties, const char* deviceId, const char* deviceProperties, int reqTimeout, const char* host, bool logEnabled, const char* sdkNamePre, const char* sdkVersion, const char* callbackObj) {
